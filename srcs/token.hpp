...
class PToken{
    ...
    private:
        PToken(TokenType type, std::size_t pos):_token{std::make_shared<OpToken>(type, pos)}{}
        PToken(TokenType type, const char * value, std::size_t pos):_token{std::make_shared<ValToken>(type, value, pos)}{}
...
class PTokenFactory{
    public:
        ...
        PToken CreatePTokenWithTypeAndValue(TokenType type, const char * value, std::size_t pos) const{
